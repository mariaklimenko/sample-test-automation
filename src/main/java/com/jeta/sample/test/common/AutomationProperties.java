...
public class AutomationProperties {
    ...
    private Boolean getBrowserHeadlessMode() {
        String headless = System.getProperty("selenide.headless");
        return headless != null ? Boolean.valueOf(headless) : Boolean.valueOf(config.getString(TEST_ENV + ".selenide.headless"));
    }

    private String getWebUrl() {
        String baseUrl = System.getProperty("web.baseurl");
        return baseUrl != null ? baseUrl : config.getString(TEST_ENV + ".web.baseurl");
    }
}